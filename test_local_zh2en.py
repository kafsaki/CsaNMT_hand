...
def zh2en():
    ...
    src_vocab_dir = "./model/damo/nlp_csanmt_translation_zh2en/src_vocab.txt"
    ...
    trg_vocab_dir = "./model/damo/nlp_csanmt_translation_zh2en/trg_vocab.txt"
    _trg_rvocab = dict([
    ...
    _src_bpe_path = "./model/damo/nlp_csanmt_translation_zh2en/bpe.zh"
    ...
    MetaGraphDef = tf.saved_model.loader.load(sess, ['serve'], './CSANMT_zh2en')
